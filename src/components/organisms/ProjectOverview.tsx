...
const capabilityItems = [
  {
    ...
    description:
      "전국 ITS CCTV API에서 CCTV 이름, 위치, 영상 URL, 도로 정보를 수집하고 DB에 저장합니다.",
  },
  {
    title: "02. 프레임 순회 분석",
    description:
      "모든 영상을 실시간 스트리밍 분석하지 않고 Python Worker가 CCTV를 순회하며 프레임 단위로 분석합니다.",
  },
  {
    title: "03. 화재/연기 위험 판단",
    description:
      "YOLO 또는 RT-DETR로 위험 후보를 필터링하고 VLM이 화재, 연기, 후미등, 조명, 안개를 정밀 구분합니다.",
  },
  {
    title: "04. 이벤트 기반 관제",
    description:
      "위험 상황 발생 시 이벤트, 스냅샷, 위험도, VLM 판단 사유를 저장하고 관제 화면에 표시합니다.",
  },
];
    ...
    <section id="overview" className="px-5 py-24 sm:px-8">
      <div className="mx-auto max-w-[1720px]">
        ...
        <div className="grid gap-5 lg:grid-cols-2">
          <OverviewCard title="Project Overview">
            <strong>Flare on the road</strong>는 전국 ITS CCTV API를 활용하여
            고속도로 CCTV 영상을 주기적으로 분석하고, 화재 및 연기 의심 상황을
            탐지하는 AI 기반 관제 시스템입니다.
          </OverviewCard>

          <OverviewCard title="Core Technology">
            본 시스템은 모든 CCTV 영상을 직접 실시간 분석하지 않고, CCTV를
            순회하며 프레임 단위로 분석합니다. 1차 탐지 모델(YOLO / RT-DETR)이
            위험 후보를 빠르게 필터링하고, 2차 VLM이 실제 화재 여부와 오탐
            가능성을 판단합니다.
          </OverviewCard>
        </div>
        ...
        <Card className="mt-5 rounded-xl border-warm-200 bg-warm-50 shadow-sm dark:border-slate-700 dark:bg-slate-800">
          <CardContent className="p-8 text-center">
            ...
            <p className="mt-3 text-xl font-semibold italic leading-8 text-slate-500 dark:text-warm-300">
              ...
              <strong>Flare on the road</strong>가 지향하는 이벤트 기반 관제의
              출발점입니다.&quot;
            </p>
          </CardContent>
        </Card>
